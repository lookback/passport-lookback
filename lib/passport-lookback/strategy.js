...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://lookback.io/authorize';
  options.tokenURL = options.tokenURL || 'https://lookback.io/auth/1/token';
  options.scopeSeparator = options.scopeSeparator || ' ';
  this.profileUrl = options.profileUrl || 'https://lookback.io//integrations/1/user?access_token=';
